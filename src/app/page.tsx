export default function Home() {
  return (
    <>
      <main className="">
        <img
          className="absolute top-110 sm:top-90 xl:top-80 -left-0 sm:-left-2 xl:-left-0 w-50 sm:w-80 xl:w-100 z-10"
          src="/flower-left.png"
          alt="flower-left"
        />
        <img
          className="absolute top-30 sm:top-40 -right-0 sm:-right-6 md:top-20 md:-right-0 w-40 sm:w-60 xl:w-80 z-10"
          src="/flower-right.png"
          alt="flower-right"
        />
        <div className="relative m-6 rounded-4xl bg-gray-50 h-140 p-4">
